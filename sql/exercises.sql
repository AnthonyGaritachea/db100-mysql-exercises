...
# 4b. Select the payment id, amount, and payment date columns from the payment table for payments made on 2/25/2005, 05/27/2005, and 05/29/2005.
...
SELECT
    ...
    city.city
FROM staff
LEFT JOIN (address, city)
ON (staff.address_id = address.address_id AND city.city_id = address.address_id);
